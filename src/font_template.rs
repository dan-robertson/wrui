...
// We need to immitate the computed values for font_stretch,
// font_variant_caps and font_weight. This turns out to be reasonably
// straightforward
pub mod font_weight {
...
pub struct FontTemplate {
    ...
    /// Used to hang onto system (and web) fonts.
    weak_ref: Option<Weak<FontTemplateData>>,
    // GWTODO: Add code path to unset the strong_ref for web fonts!
    /// Used to hang onto web fonts (where it is not so easy to get the data again).
