/* font handling and text layout code. Largely from the gfx module in servo */
...
// we use the same FontHandle as servo
// This encapsulates access to the platform's font API.
